...
//   // Email, password validation for login and Email and password function for signup
...
//   //funcationality for forgot password
...
//                 className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-green-300"
...
//             <button
//               type="submit"
//               className="bg-bg_darkgreen mt-8 text-white rounded-md py-2 px-36 w-full hover:text-text_darkgreen hover:bg-bg_green focus:outline-none focus:ring focus:border-green-300"
//             >
//               {isLoginForm ? "Login" : "Signup"}
//             </button>
