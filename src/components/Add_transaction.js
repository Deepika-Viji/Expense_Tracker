...
const AddTransaction = () => {
  ...
  const handleAddTransaction = async () => {
    ...
    try {
      ...
      const transactionMonth = selectedDate.getMonth() + 1; // Months are 0-based
      ...
      >
        <div>
          ...
          <div className="flex justify-end mt-10 ml-7">
            <button
              className="bg-add_button text-text_darkgreen p-2 rounded-lg w-20 font-semibold hover:bg-bg_green hover:text-text_darkgreen"
